...
const PhoneSkeletonCard = ({darkMode} : {darkMode: boolean}) => {
    return (
    <Grid container className={darkMode ? "darkCardContainer" : "cardContainer"} style={{width: '250px', border: '1px solid #eee', maxHeight: 287, margin: 10}}>
        <div>
            ...
            <div className="card-textarea" style={{paddingTop: 10, display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                ...
                <Skeleton height="20px" width="50px" variant="rect" style={{marginTop: 8}}/>
            </div>
          </div>
...
export default PhoneSkeletonCard;
